...
OPTIMIZATION = s
TARGET       = main
SRC          = $(TARGET).c Descriptors.c Board/Hardware.c Board/commands.c Board/tcs3414.c Board/sht25.c Board/at45db321d.c Board/mpl115a1.c $(COMMON_PATH)/spi.c $(COMMON_PATH)/i2c_soft.c $(COMMON_PATH)/command.c $(COMMON_PATH)/dfu_jump.c version.c $(LUFA_SRC_USB) $(LUFA_SRC_USBCLASS)
